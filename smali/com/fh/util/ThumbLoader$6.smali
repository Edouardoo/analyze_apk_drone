.class Lcom/fh/util/ThumbLoader$6;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/fh/util/ThumbLoader;->getThumbFromMov(Landroid/content/Context;Ljava/lang/String;IILandroid/os/Handler;Lcom/fh/util/ThumbLoader$OnLoadVideoThumbListener;)V
.end annotation
...
.method constructor <init>(Lcom/fh/util/ThumbLoader;IILjava/lang/String;Landroid/os/Handler;Lcom/fh/util/ThumbLoader$OnLoadVideoThumbListener;Landroid/content/Context;)V
    ...
    .prologue
    .line 642
    iput-object p1, p0, Lcom/fh/util/ThumbLoader$6;->this$0:Lcom/fh/util/ThumbLoader;

    iput p2, p0, Lcom/fh/util/ThumbLoader$6;->val$width:I

    iput p3, p0, Lcom/fh/util/ThumbLoader$6;->val$height:I

    iput-object p4, p0, Lcom/fh/util/ThumbLoader$6;->val$path:Ljava/lang/String;

    iput-object p5, p0, Lcom/fh/util/ThumbLoader$6;->val$handler:Landroid/os/Handler;

    iput-object p6, p0, Lcom/fh/util/ThumbLoader$6;->val$listener:Lcom/fh/util/ThumbLoader$OnLoadVideoThumbListener;

    iput-object p7, p0, Lcom/fh/util/ThumbLoader$6;->val$context:Landroid/content/Context;
...
.method public onCompleted([BLcom/jieli/media/codec/bean/MediaMeta;)V
    ...
    const-string v2, "getThumbFromMov -onCompleted- bytes size="
    ...
    iget v1, p0, Lcom/fh/util/ThumbLoader$6;->val$width:I
    ...
    iget v1, p0, Lcom/fh/util/ThumbLoader$6;->val$height:I

    if-le v0, v1, :cond_2

    .line 665
    :cond_1
    iget v0, p0, Lcom/fh/util/ThumbLoader$6;->val$width:I
    ...
    .line 667
    iget-object v0, p0, Lcom/fh/util/ThumbLoader$6;->this$0:Lcom/fh/util/ThumbLoader;

    invoke-static {v0}, Lcom/fh/util/ThumbLoader;->access$200(Lcom/fh/util/ThumbLoader;)Landroid/util/LruCache;

    move-result-object v0

    iget-object v1, p0, Lcom/fh/util/ThumbLoader$6;->val$path:Ljava/lang/String;
    ...
    const-string v2, "-getThumbFromMov- duration = "
    ...
    .line 671
    iget-object v0, p0, Lcom/fh/util/ThumbLoader$6;->val$handler:Landroid/os/Handler;

    new-instance v1, Lcom/fh/util/ThumbLoader$OnLoadVideoThumbRunnable;

    iget-object v2, p0, Lcom/fh/util/ThumbLoader$6;->this$0:Lcom/fh/util/ThumbLoader;

    iget-object v3, p0, Lcom/fh/util/ThumbLoader$6;->val$listener:Lcom/fh/util/ThumbLoader$OnLoadVideoThumbListener;
    ...
    const-string v2, "-getThumbFromMov- saveThumbPath="
    ...
    iget-object v1, p0, Lcom/fh/util/ThumbLoader$6;->val$context:Landroid/content/Context;

    const/4 v2, 0x0

    iget v3, p0, Lcom/fh/util/ThumbLoader$6;->val$width:I

    iget v4, p0, Lcom/fh/util/ThumbLoader$6;->val$height:I

    iget-object v5, p0, Lcom/fh/util/ThumbLoader$6;->val$listener:Lcom/fh/util/ThumbLoader$OnLoadVideoThumbListener;
