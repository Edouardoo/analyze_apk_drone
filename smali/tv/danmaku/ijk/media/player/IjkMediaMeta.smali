...
.method public static parse(Landroid/os/Bundle;)Ltv/danmaku/ijk/media/player/IjkMediaMeta;
    ...
    .line 198
    .local v2, "meta":Ltv/danmaku/ijk/media/player/IjkMediaMeta;
    iput-object p0, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    .line 200
    const-string v8, "format"

    invoke-virtual {v2, v8}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mFormat:Ljava/lang/String;

    .line 201
    const-string v8, "duration_us"

    invoke-virtual {v2, v8}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mDurationUS:J
    ...
    iput-wide v8, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mStartUS:J
    ...
    iput-wide v8, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mBitrate:J

    .line 205
    const-string v8, "video"

    invoke-virtual {v2, v8, v10}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 209
    .local v6, "subtitleStreamIndex":I
    const-string v8, "streams"

    .line 210
    invoke-virtual {v2, v8}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 222
    new-instance v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    invoke-direct {v4, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V

    .line 223
    .local v4, "streamMeta":Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
    iput-object v3, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    .line 224
    const-string v9, "type"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    .line 226
    iget-object v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    .line 229
    const-string v9, "codec_name"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;

    .line 230
    const-string v9, "codec_profile"
    ...
    iput-object v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;

    .line 232
    const-string v9, "codec_long_name"
    ...
    iput-object v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    .line 234
    const-string v9, "bitrate"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    int-to-long v10, v9

    iput-wide v10, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mHeight:I

    .line 239
    const-string v9, "fps_num"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I

    .line 240
    const-string v9, "fps_den"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I

    .line 241
    const-string v9, "tbr_num"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I

    .line 242
    const-string v9, "tbr_den"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I

    .line 243
    const-string v9, "sar_num"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarNum:I

    .line 244
    const-string v9, "sar_den"

    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v9

    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    .line 246
    if-ne v7, v1, :cond_3

    .line 247
    iput-object v4, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mVideoStream:Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    .line 259
    :cond_3
    :goto_1
    iget-object v9, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
    ...
    iput v9, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    .line 252
    const-string v9, "channel_layout"

    .line 253
    invoke-virtual {v4, v9}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v10

    iput-wide v10, v4, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    .line 255
    if-ne v0, v1, :cond_3

    .line 256
    iput-object v4, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mAudioStream:Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
